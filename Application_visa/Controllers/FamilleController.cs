...
namespace Application_visa.Controllers
{
    public class FamilleController : Controller
    {
        ...
        [HttpPost]
        public IActionResult Index(Famille edd)
        {
        ...
        public IActionResult Modifier(int id)
        {
            ...
            return View(Famille.getFamille(id));
        }

        [HttpPost]
        public IActionResult Modifier(Famille app)
        {
            if (app.prix >= app.charge + app.charge2 + app.charge3 && app.total >= app.charge + app.charge2 + app.charge3)
            {
                ...
                app.update();
                ViewData["erorPrix"] = "l'Famille a etait bien enregistrer";
                return RedirectToAction("index", "Home");
            }
