...

{
    public class User
    {
        ...
        public void updatepwd(String pwd)
        {
            ...
            con.Open();
            String query = "UPDATE user set pwd = @pwd where id = @id";
            MySqlCommand cmd = new MySqlCommand(query, con);
            cmd.Parameters.Add(new MySqlParameter("@pwd", hashPassword(pwd)));
        ...
        public static User getUserPassword(int empId)
        {
            MySqlConnection conn = new MySqlConnection("server=localhost;database=apk_visa;uid=root;password=;"); ;
            conn.Open();
            using MySqlCommand command = conn.CreateCommand();
